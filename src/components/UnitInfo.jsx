import { Truck, Hash, User, Gauge, Calendar, MapPin, ShieldCheck, CheckCircle2 } from 'lucide-react'
...
export default function UnitInfo() {
  ...
  const fields = [
    ...
    { id: 'odometer', label: t('odometer'), icon: Gauge, type: 'number', placeholder: '125,000' },
